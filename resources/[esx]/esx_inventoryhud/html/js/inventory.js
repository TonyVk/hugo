...
function itemDescriptionOn(obj) {
    ...
    if (itemData.label !== undefined) {
        var element = $("<div class='item-desc-info'><p><span id='item-name'>"+ itemData.label +"</span></p><hr class='item-hr'><p><span id='item-desc'>" + itemData.description + "</span></p><p><span id='item-amount'><span class='strong'>Hoeveelheid</span>: " + itemData.amount + "</span></p><p><span id='item-limit'><span class='strong'>Gewicht p.st.</span>: " + (itemData.limit / 1000).toFixed(2) + " kg</span></p></div>") .fadeIn(200);
