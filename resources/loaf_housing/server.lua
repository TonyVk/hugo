    ...
    if houses[owner] then
        if instances[houses[owner]] then
                    ...
                    if inventory.getItem(item)['count'] >= amount then
						...
						if torba then
							if xItem.limit ~= -1 and (xItem.count + amount) > xItem.limit*2 then
                                ...
                                TriggerEvent("DiscordBot:Sefovi", GetPlayerName(source).." je uzeo ".. amount .. "x " .. item .. " iz sefa kuce.")
							end
						else
            ...
            elseif type == 'weapon' then
                ...
                TriggerEvent("DiscordBot:Sefovi", GetPlayerName(source).." je uzeo ".. item .. " sa " .. amount .. " metaka iz sefa kuce.")
            end
        end
        ...
        if instances[houses[owner]] then
            ...
            if type == 'item' then
                ...
                if xPlayer.getInventoryItem(item)['count'] >= amount then
                    ...
                    TriggerEvent("DiscordBot:Sefovi", GetPlayerName(source).." je ostavio ".. amount .. "x " .. item .. " u sef kuce.")
                else
            ...
            elseif type == 'weapon' then
                ...
                if hasweapon then
                    ...
                    TriggerEvent("DiscordBot:Sefovi", GetPlayerName(source).." je ostavio ".. item .. " sa " .. amount .. " metaka u sef kuce.")
                else
...
ESX.RegisterServerCallback('kuce:JelNaProdaju', function(source, cb, tablica)
