...
local orgy
local orgsusp
RegisterCommand("testzracni", function(source, args, raw)
	if tonumber(args[1]) == 1 then
		local vehica = GetVehiclePedIsIn(PlayerPedId())
		...
		local veho = GetVehiclePedIsIn(PlayerPedId())
		...
		local prosliy = GetVehicleWheelYRotation(veho, 0)
		local novibr = 0.0
		while prosliy < novibr do
