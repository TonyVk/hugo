...
--//Kick Message//--
ChXaS.KickMessage = "Citeri nisu dobrodosli!" -- You can edit this UwU
...
ChXaS.MaxWeaponAmmo = 250 -- Automatically detect if someone tries to give themself/someone else more than 100 ammos NEW!
